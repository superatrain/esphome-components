...
DEFAULT_SWITCH_PIN = 5
DEFAULT_BUTTON_PIN = 14

_LOGGER = logging.getLogger(__name__)

component_name = "z9260"

z9260_ns = cg.esphome_ns.namespace(component_name)
Z9260 = z9260_ns.class_(
    "Z9260", cg.PollingComponent, switch.Switch, uart.UARTDevice
)
...
CONFIG_SCHEMA = (
    binary_sensor.BINARY_SENSOR_SCHEMA.extend(
        {
            cv.GenerateID(): cv.declare_id(Z9260),
